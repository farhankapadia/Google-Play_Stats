...
def gui_19_2():
    ...
    global screen_19_2
    screen_19_2=Tk()
    screen_19_2.configure(bg='white')
    screen_19_2.geometry("600x665+600+100")
    Label(screen_19_2, text=" GOOGLE PLAY STATS", width='35', height="2", font=("Times New Roman", 40,'bold'), fg='white', bg='#00FFAF',anchor=NW,justify=CENTER).place(x=0, y=0)
    Label(screen_19_2, text="",bg='#B9FFFF',width=76,height=34).place(x=32,y=80)
    Label(screen_19_2, text="  Top 5 Free & Paid Apps",bg='#800080',fg='white',width=35,height=2, font=("Times New Roman", 19,'bold'),anchor=W).place(x=36,y=80)
    Label(screen_19_2, text="Top 5 Free Apps (Acc. Rating)",fg='#002F2F',bg='#B9FFFF', font=("Times New Roman", 19,'bold')).place(x=150,y=160)
    Label(screen_19_2, text=free_appname,fg='#002F2F',bg='#B9FFFF', font=("Times New Roman", 12),width=36,height=8,anchor=W,justify=LEFT).place(x=60,y=200)
    Label(screen_19_2, text=free_rating,fg='#002F2F',bg='#B9FFFF', font=("Times New Roman", 12),width=5,height=8,anchor=NE,justify=RIGHT).place(x=390,y=200)
    Label(screen_19_2, text=free_installs,fg='#002F2F',bg='#B9FFFF', font=("Times New Roman", 12),width=8,height=8,anchor=NE,justify=RIGHT).place(x=460,y=200)
    Label(screen_19_2, text="Top 5 Paid Apps (Acc. Rating)",fg='#002F2F',bg='#B9FFFF', font=("Times New Roman", 19,'bold')).place(x=150,y=360)
    Label(screen_19_2, text=paid_appname,fg='#002F2F',bg='#B9FFFF', font=("Times New Roman", 12),width=30,height=8,anchor=W,justify=LEFT).place(x=60,y=400)
    Label(screen_19_2, text=paid_rating,fg='#002F2F',bg='#B9FFFF', font=("Times New Roman", 12),width=5,height=8,anchor=NE,justify=RIGHT).place(x=390,y=400)
    Label(screen_19_2, text=paid_installs,fg='#002F2F',bg='#B9FFFF', font=("Times New Roman", 12),width=8,height=8,anchor=NE,justify=RIGHT).place(x=460,y=400)
    Button(screen_19_2, text="Back", bg="#00CDCD", width=15, height=1, font=("Open Sans",13,"bold"),fg="white",command=screen_19_2.destroy).place(x=225,y=575)
    screen_19_2.mainloop()
