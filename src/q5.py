# -*- coding: utf-8 -*-
"""
Created on Wed Jul 10 00:49:30 2019
...
def q5():
    ...
    Data7= {"Categories" : categ, "Downloads" : sum_list}
    df7= DataFrame(Data7, columns= ["Categories", "Downloads"])
    root= Tk()
    ...
    ax1.set_title('Categories Vs. No. of Downloads')
